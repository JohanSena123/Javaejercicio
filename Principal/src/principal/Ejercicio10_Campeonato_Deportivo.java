 ...
 * @author AdminSena
 */
public class Ejercicio10_Campeonato_Deportivo {
    
    public Ejercicio10_Campeonato_Deportivo(){
        procesar();
    }
    ...
    public static void procesar(){
     Scanner TomarDatos=new Scanner(System.in);
        ...
        Ejercicio10_Campeonato_Deportivo.rango(equipo1,resultado1);
        Ejercicio10_Campeonato_Deportivo.rango(equipo2,resultado2);
    }
